...
############################################
# Step 2: collecting following accounts
############################################
pushd ./following
timeout --foreground --kill-after 5s 20m \
opencode run -m $MODEL \
