...
cat << USAGE
Description:
upload to remote bloghost / sync localhost database, meanwhile update xml feed.
Examples:
$0 remote 2015/8
$0 remote schedule
$0 local .
...
tkblog_blog="/home/tk/tksync/proj/tkblog/blog"
...
if [ "$year_month" == 'schedule' ]; then
	echo "[ upload schedule blog post... ]"
	echo "$tkblog_blog/2015/9/blog/2015-09-10-02-00-1089.txt" > ${upload_log}
else
	mk_upload_log_from_year_month
fi
