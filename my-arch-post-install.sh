...
pacman --noconfirm -S mplayer # best media player
...
pacman --noconfirm -S xfce4-screenshooter # screenshot
...
pacman --noconfirm -S networkmanager # NetworkManager.service
